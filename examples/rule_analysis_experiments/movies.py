...
def execute(save_dir, data, n_buckets=3, i=None, bucketing_method="quantile", statistic="median"):
...
def run_multiple_executions(save_dir, num_buckets, num_iterations, dataset_name, dataset):
    ...
    for n_buckets in range(2, num_buckets + 1):
        ...
        for iteration in range(1, num_iterations + 1):
            ...
            if not os.path.exists(expected_result_path):
                ...
                results = execute(save_dir=save_dir, n_buckets=n_buckets, i=iteration, statistic="median", data=dataset)
