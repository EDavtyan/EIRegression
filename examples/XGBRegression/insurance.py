...
def execute(save_dir, n_buckets=3, i=None, bucketing_method="quantile", single_rules_breaks=3):
    # Load dataframe
    data = pd.read_csv("/home/edgar.davtyan/projects/recla_v1/examples/datasets/insurance.csv")
    # data = pd.read_csv("/Users/eddavtyan/Documents/XAI/Projects/EIRegression/examples/datasets/insurance.csv")
    target = "charges"
...
if __name__ == '__main__':
    save_dir = "examples/RFRegression/insurance"
