...
from EIRegressor.EmbeddedInterpreterEnsemble import EmbeddedInterpreterEnsemble
import pandas as pd
...
def execute(save_dir, n_buckets=3, i=None, bucketing_method="quantile", statistic="median"):
    ...
    eiReg = EmbeddedInterpreterEnsemble(n_buckets=n_buckets,
...
if __name__ == '__main__':
    save_dir = "/Users/eddavtyan/Documents/XAI/Projects/EIRegression/examples/improved_with_ensemble/kmeans_ensemble_median/results/concrete"
    # run_multiple_executions(save_dir, 3, 3)
    execute(save_dir=save_dir, n_buckets=3, i=2, statistic="median")
